...
int mvcim::transzip()
{
	...
	while((dirt = readdir(dirp)) != NULL)
	{
		...
		{
			if(strstr(file_name,"35401_") != NULL)
				citycode = 0;
			else if(strstr(file_name,"35402_") != NULL)
				citycode = 1;
			else if(strstr(file_name,"35403_") != NULL)
				citycode = 2;
			else if(strstr(file_name,"35404_") != NULL)
				citycode = 3;
			else if(strstr(file_name,"35405_") != NULL)
				citycode = 4;
			else if(strstr(file_name,"35406_") != NULL)
				citycode = 5;
			else if(strstr(file_name,"35407_") != NULL)
				citycode = 6;
			else if(strstr(file_name,"35408_") != NULL)
				citycode = 7;
			else if(strstr(file_name,"35409_") != NULL)
				citycode = 8;
			else
				citycode = 9;
