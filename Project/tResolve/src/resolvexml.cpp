...
int resolvexmldata::import_xml(TiXmlDocument &doc,const char *filename,logstr& threadlog)
{
	...
	enum xmltype {_ZZZX_,_DATT_,_DAGC_,_YXBW_,_GPZW_,_DMSGPZW_,_GPMSGPZW_,_ZDZX_,_YKCZ_,_YXINFO_,_RATE_,_BUS_,_CB_,_DSC_,_TRANS_,_SUBS_,_TDTRANS_,_AUTOMAP_,_TQREALEASE_,_FASTR_,_TZLIST_,_GPMSTD_,_GPMSTDDET_,_GPMSZLPDET_,_DMSZLPDET_,_DMSXSD_,_DMSYD_,_GPMSYD_,_GZZSQ_,_DMSYCRT_,_DMSEMSRT_,_DMSYXRT_,_DMSLINE_,_DMSXSDET_,_DMSZTGJDET_,_END_,_LOG_,_UnKnownFileType_}g_xmltype;

	const char *g_xmltypeName[] = {"ZZZX","DATT","DAGC","YXBW","GPZW","DMSGPZW","GPMSGPZW","ZDZX","YKCZ","YXINFO","dmsindex","buslist","cblist","dsclist","translist","subslist","tdtrans","automap","tdrelease","fastr","tzlist","gpmstd","gpmstddet","gpmszlpdet","zlp","wkwh","dmsyd","gpmsydddet","GZZSQ","YCRHT","EMSRHT","ztgj","line","xsdcltratedet","ztgjdet","END","LOG"};
			...
			case _DMSYD_:
				{
					...
					for (;thrElement_gpmstddet != NULL;thrElement_gpmstddet = thrElement_gpmstddet->NextSiblingElement())
					{
						...
						if (strstr(temp_dmsyd.id,"LS") != NULL) { //剔除离线异动
			...
			case _GZZSQ_:
				{
					...
					if(fabs(gzzsq_temp.cover_rate)<=float_border)
					{
						...
						sprintf(qury,"insert into evalusystem.manage.err_file(file_name,err_file_path,date,organ_code,count_file_path,dis,source) values "
							"(:1,:2,to_date(sysdate,'YYYY-MM-DD HH24:MI:SS'),:3,:4,'故障指示器覆盖率数值为零','dms');");
						if(d5000.d5000_WriteData("DMSCBL_IMAGE",qury,temp_err,1,4,attrs,error_info) != 0)
						{
							return -1;
						}
					...
					if(fabs(gzzsq_temp.shake_rate)<=float_border)
					{
						...
						sprintf(qury,"insert into evalusystem.manage.err_file(file_name,err_file_path,date,organ_code,count_file_path,dis,source) values "
							"(:1,:2,to_date(sysdate,'YYYY-MM-DD HH24:MI:SS'),:3,:4,'故障指示器抖动率数值为零','dms');");
						if(d5000.d5000_WriteData("DMSCBL_IMAGE",qury,temp_err,1,4,attrs,error_info) != 0)
						{
							return -1;
						}
					...
					if(fabs(gzzsq_temp.misoperation_rate)<=float_border)
					{
						...
						sprintf(qury,"insert into evalusystem.manage.err_file(file_name,err_file_path,date,organ_code,count_file_path,dis,source) values "
							"(:1,:2,to_date(sysdate,'YYYY-MM-DD HH24:MI:SS'),:3,:4,'故障指示器误动率数值为零','dms');");
						if(d5000.d5000_WriteData("DMSCBL_IMAGE",qury,temp_err,1,4,attrs,error_info) != 0)
						{
							return -1;
						}
					...
					if(fabs(gzzsq_temp.missreport_rate)<=float_border)
					{
						...
						sprintf(qury,"insert into evalusystem.manage.err_file(file_name,err_file_path,date,organ_code,count_file_path,dis,source) values "
							"(:1,:2,to_date(sysdate,'YYYY-MM-DD HH24:MI:SS'),:3,:4,'故障指示器漏报率数值为零','dms');");
						if(d5000.d5000_WriteData("DMSCBL_IMAGE",qury,temp_err,1,4,attrs,error_info) != 0)
						{
							return -1;
						}
					...
					if(fabs(gzzsq_temp.tworatiocover_rate)<=float_border)
					{
						...
						sprintf(qury,"insert into evalusystem.manage.err_file(file_name,err_file_path,date,organ_code,count_file_path,dis,source) values "
							"(:1,:2,to_date(sysdate,'YYYY-MM-DD HH24:MI:SS'),:3,:4,'二遥终端覆盖率数值为零','dms');");
						if(d5000.d5000_WriteData("DMSCBL_IMAGE",qury,temp_err,1,4,attrs,error_info) != 0)
						{
							return -1;
						}
					...
					if(fabs(gzzsq_temp.threeratiocover_rate)<=float_border)
					{
						...
						sprintf(qury,"insert into evalusystem.manage.err_file(file_name,err_file_path,date,organ_code,count_file_path,dis,source) values "
							"(:1,:2,to_date(sysdate,'YYYY-MM-DD HH24:MI:SS'),:3,:4,'三遥终端覆盖率数值为零','dms');");
						if(d5000.d5000_WriteData("DMSCBL_IMAGE",qury,temp_err,1,4,attrs,error_info) != 0)
						{
							return -1;
						}
			...
			case _DMSYCRT_:
				{
					...
					if(fabs(ycrt_temp.yc_right)<=float_border)
					{
						...
						sprintf(qury,"insert into evalusystem.manage.err_file(file_name,err_file_path,date,organ_code,count_file_path,dis,source) values "
							"(:1,:2,to_date(sysdate,'YYYY-MM-DD HH24:MI:SS'),:3,:4,'遥测正确率数值为零','dms');");
						if(d5000.d5000_WriteData("DMSCBL_IMAGE",qury,temp_err,1,4,attrs,error_info) != 0)
						{
							return -1;
						}
			...
			case _DMSEMSRT_:
				{
					...
					if(fabs(emsrt_temp.emszfrt)<=float_border)
					{
						...
						sprintf(qury,"insert into evalusystem.manage.err_file(file_name,err_file_path,date,organ_code,count_file_path,dis,source) values "
							"(:1,:2,to_date(sysdate,'YYYY-MM-DD HH24:MI:SS'),:3,:4,'EMS转发正确率数值为零','dms');");
						if(d5000.d5000_WriteData("DMSCBL_IMAGE",qury,temp_err,1,4,attrs,error_info) != 0)
						{
							return -1;
						}
			...
			case _DMSYXRT_:
				{
					...
					if(fabs(yxrt_temp.yx_right)<=float_border)
					{
						...
						sprintf(qury,"insert into evalusystem.manage.err_file(file_name,err_file_path,date,organ_code,count_file_path,dis,source) values "
							"(:1,:2,to_date(sysdate,'YYYY-MM-DD HH24:MI:SS'),:3,:4,'遥信状态辨识正确率数值为零','dms');");
						if(d5000.d5000_WriteData("DMSCBL_IMAGE",qury,temp_err,1,4,attrs,error_info) != 0)
						{
							return -1;
						}
...
int resolvexmldata::insertDB(int arg,logstr& threadlog,const char *filename)
{
	...
	enum filetype {_ZZZX_,_DATT_,_DAGC_,_YXBW_,_GPZW_,_DMSGPZW_,_GPMSGPZW_,_ZDZX_,_YKCZ_,_YXINFO_,_RATE_,_BUS_,_CB_,_DSC_,_TRANS_,_SUBS_,_TDTRANS_,_AUTOMAP_,_TQRELEASE_,_FASTR_,_TZLIST_,_GPMSTD_,_GPMSTDDET_,_GPMSZLPDET_,_DMSZLPDET_,_DMSXSD_,_DMSYD_,_GPMSYD_,_DMSGZZSQ_,_DMSYCRT_,_DMSEMSRT_,_DMSYXRT_,_DMSLINE_,_DMSXSDET_,_DMSZTGJDET_,_END_,_UnKnownFileType_}g_filetype;
	const char *g_strfiletypeName[] = {"DMSOP","DATT","DAGC","YXBW","GPZW","DMSGPZW","GPMSGPZW","ZDZX","YKCZ","YXINFO","YCRATE","DMSBUS","DMSCB","DMSCB","DMSLD","DMSST","DMSTD","AUTOGRAPH","TDINFO","FACTION","TZDETAILS","GPMSTD","GPMSTDDET","GPMS_ZLP","DMS_ZLP","DMS_XSD","DMS_ZTGJ","DMS_YD","GPMS_YD","GZZSQ","YCRHT","ztgj","line","xsdcltratedet","END"};
	...
	case _DMSGZZSQ_:
		{
			...
			{
				SetGError(0,0,NULL,_DMSGZZSQ_-2,"文件内容为空",threadlog);  //待梳理
				break;
			}
			struct ColAttr* attrs = (ColAttr* )malloc(sizeof(ColAttr_t)*8);
			if(attrs == NULL)
			...
			{
				SetGError(1,0,g_strfiletypeName[arg],_DMSGZZSQ_-2,"入库成功.",threadlog);
			}
	...
	case _DMSYCRT_:
		{
			...
			{
				SetGError(0,0,NULL,_DMSYCRT_-2,"文件内容为空",threadlog);  //待梳理
				break;
			}
			struct ColAttr* attrs = (ColAttr* )malloc(sizeof(ColAttr_t)*3);
			if(attrs == NULL)
			...
			{
				SetGError(1,0,g_strfiletypeName[arg],_DMSYCRT_-2,"入库成功.",threadlog);
			}
	...
	case _DMSEMSRT_:
		{
			...
			{
				SetGError(0,0,NULL,_DMSEMSRT_-2,"文件内容为空",threadlog);  //待梳理
				break;
			}
			struct ColAttr* attrs = (ColAttr* )malloc(sizeof(ColAttr_t)*3);
			if(attrs == NULL)
			...
			{
				SetGError(1,0,g_strfiletypeName[arg],_DMSEMSRT_-2,"入库成功.",threadlog);
			}
	...
	case _DMSYXRT_:
		{
			...
			{
				SetGError(0,0,NULL,_DMSYXRT_-2,"文件内容为空",threadlog);  //待梳理
				break;
			}
			struct ColAttr* attrs = (ColAttr* )malloc(sizeof(ColAttr_t)*3);
			if(attrs == NULL)
			...
			{
				SetGError(1,0,g_strfiletypeName[arg],_DMSYXRT_-2,"入库成功.",threadlog);
			}
	...
	case _DMSLINE_:
		{
			...
			{
				SetGError(0,0,NULL,_DMSLINE_-2,"文件内容为空",threadlog);  //待梳理
				break;
			}
			struct ColAttr* attrs = (ColAttr* )malloc(sizeof(ColAttr_t)*7);
			if(attrs == NULL)
			...
			{
				SetGError(1,0,g_strfiletypeName[arg],_DMSLINE_-2,"入库成功.",threadlog);
			}
	...
	case _DMSXSDET_:
		{
			...
			{
				SetGError(0,0,NULL,_DMSXSDET_-2,"文件内容为空",threadlog);  //待梳理
				break;
			}
			struct ColAttr* attrs = (ColAttr* )malloc(sizeof(ColAttr_t)*4);
			if(attrs == NULL)
	...
	case _DMSZTGJDET_:
		{
			...
			{
				SetGError(0,0,NULL,_DMSZTGJDET_-2,"文件内容为空",threadlog);  //待梳理
				break;
			}
			struct ColAttr* attrs = (ColAttr* )malloc(sizeof(ColAttr_t)*5);
			if(attrs == NULL)
			...
			{
				SetGError(1,0,g_strfiletypeName[arg],_DMSZTGJDET_-2,"入库成功.",threadlog);
			}
...
int resolvexmldata::deleteDBDate(int code,int arg)
{
	...
	enum filetype {_ZZZX_,_DATT_,_DAGC_,_YXBW_,_GPZW_,_DMSGPZW_,_GPMSGPZW_,_ZDZX_,_YKCZ_,_YXINFO_,_RATE_,_BUS_,_CB_,_DSC_,_TRANS_,_SUBS_,_TDTRANS_,_AUTOMAP_,_TQREALEASE_,_FASTR_,_TZLIST_,_GPMSTD_,_GPMSTDDET_,_GPMSZLPDET_,_DMSZLPDET_,_DMSXSD_,_DMSYD_,_GPMSYD_,_GZZSQ_,_DMSYCRT_,_DMSEMSRT_,_DMSYXRT_,_DMSLINE_,_DMSXSDET_,_DMSZTGJDET_,_END_,_UnKnownFileType_}g_filetype;
	//const char *g_xmltypeName[] = {"DMSOP","DATT","DAGC","YXBW","GPZW","DMSGPZW","GPMSGPZW","ZDZX","YKCZ","YXINFO","DMSCIME","GPMSCIME","DMSDATA","GPMSDATA","END"};
	const char *g_xmltypeName[] = {"DMSOP","DATT","DAGC","YXBW","GPZW","DMSBRAND","GPMSGPZW","ZDZX","YKCZ","YXINFO","YCRATE","DMSBUS","DMSCB","DMSCB","DMSLD","DMSST","DMSTD","AUTOGRAPH","TDINFO","FACTION","TZDETAILS","GPMSTD","GPMSTDDET","GPMS_ZLP","DMS_ZLP","DMS_XSD","DMS_YD","GPMS_YD","GZZSQ","YCRT","EMSRT","YXRT","DMSLINE","DMS_XSD_DET","DMS_ZTGJ_DET","END"};
