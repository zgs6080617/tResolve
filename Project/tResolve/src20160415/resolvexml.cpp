...
int resolvexmldata::import_xml(TiXmlDocument &doc,const char *filename,logstr& threadlog)
{
	...
	enum xmltype {_ZZZX_,_DATT_,_DAGC_,_YXBW_,_GPZW_,_DMSGPZW_,_GPMSGPZW_,_ZDZX_,_YKCZ_,_YXINFO_,_RATE_,_BUS_,_CB_,_DSC_,_TRANS_,_SUBS_,_TDTRANS_,_AUTOMAP_,_TQREALEASE_,_FASTR_,_TZLIST_,_GPMSTD_,_GPMSTDDET_,_GPMSZLPDET_,_DMSZLPDET_,_DMSXSD_,_DMSYD_,_GPMSYD_,_GZZSQ_,_DMSYCRT_,_DMSEMSRT_,_DMSYXRT_,_DMSLINE_,_END_,_LOG_,_UnKnownFileType_}g_xmltype;

	const char *g_xmltypeName[] = {"ZZZX","DATT","DAGC","YXBW","GPZW","DMSGPZW","GPMSGPZW","ZDZX","YKCZ","YXINFO","dmsindex","buslist","cblist","dsclist","translist","subslist","tdtrans","automap","tdrelease","fastr","tzlist","gpmstd","gpmstddet","gpmszlpdet","zlp","wkwh","dmsyd","gpmsydddet","GZZSQ","YCRHT","EMSRHT","ztgj","line","END","LOG"};
			...
			case _DMSYD_:
				{
					...
					for (;thrElement_gpmstddet != NULL;thrElement_gpmstddet = thrElement_gpmstddet->NextSiblingElement())
					{
						...
						for(;attributeOfthr_gpmstddet != NULL;attributeOfthr_gpmstddet = attributeOfthr_gpmstddet->Next())
						{
							...
							if(strcasecmp(attname,"id") == 0)
							{
								if (strstr(attvalue,"LS") == NULL) { //剔除离线异动
			...
			case _DMSLINE_:
				{
					...
					{
						memset(&lines_temp,0,sizeof(subs));
...
int resolvexmldata::insertDB(int arg,logstr& threadlog,const char *filename)
{
	...
	enum filetype {_ZZZX_,_DATT_,_DAGC_,_YXBW_,_GPZW_,_DMSGPZW_,_GPMSGPZW_,_ZDZX_,_YKCZ_,_YXINFO_,_RATE_,_BUS_,_CB_,_DSC_,_TRANS_,_SUBS_,_TDTRANS_,_AUTOMAP_,_TQRELEASE_,_FASTR_,_TZLIST_,_GPMSTD_,_GPMSTDDET_,_GPMSZLPDET_,_DMSZLPDET_,_DMSXSD_,_DMSYD_,_GPMSYD_,_DMSGZZSQ_,_DMSYCRT_,_DMSEMSRT_,_DMSYXRT_,_DMSLINE_,_END_,_UnKnownFileType_}g_filetype;
	const char *g_strfiletypeName[] = {"DMSOP","DATT","DAGC","YXBW","GPZW","DMSGPZW","GPMSGPZW","ZDZX","YKCZ","YXINFO","YCRATE","DMSBUS","DMSCB","DMSCB","DMSLD","DMSST","DMSTD","AUTOGRAPH","TDINFO","FACTION","TZDETAILS","GPMSTD","GPMSTDDET","GPMS_ZLP","DMS_ZLP","DMS_XSD","DMS_ZTGJ","DMS_YD","GPMS_YD","GZZSQ","YCRHT","ztgj","line","END"};
	...
	case _DMSXSD_:
		{
			...
			strcpy(query,"INSERT INTO EVALUSYSTEM.DETAIL.DMS_XSD(ORGAN_CODE,VALUE,COUNT_TIME,SEND_TIME,NUM) VALUES(:1,round(:2,4),to_date(:3,'YYYY-MM-DD HH24:MI:SS'),to_date(:4,'YYYY-MM-DD HH24:MI:SS'),5);");
		
			if(d5000.d5000_WriteData("DMS_XSD",query,temp_dmsxsd,number,5,attrs,error_info) != 0)
			{
	...
	case _GPMSYD_:
		{
			...
			strcpy(query,"INSERT INTO EVALUSYSTEM.DETAIL.GPMS_YD(ORGAN_CODE,ORGAN_NAME,YDD_ID,SEND_TIME) VALUES(:1,:2,:3,to_date(:4,'YYYY-MM-DD HH24:MI:SS'));");
		
			if(d5000.d5000_WriteData("GPMS_YD",query,temp_gpmsyd,number,4,attrs,error_info) != 0)
			{
	...
	case _DMSGZZSQ_:
		{
			...
			strcpy(query,"INSERT INTO EVALUSYSTEM.DETAIL.GZZSQ(ORGAN_CODE,COVER_RATE,SHAKE_RATE,MISOPERATION_RATE,MISSREPORT_RATE,COUNT_TIME,tworatiocover_rate,threeratiocover_rate) "
				"VALUES(:1,round(:2,4),round(:3,4),round(:4,4),round(:5,4),to_date(:6,'YYYY-MM-DD HH24:MI:SS'),:7,:8)");
			if(d5000.d5000_WriteData("GZZSQ",query,temp_gzzsq,number,6,attrs,error_info) != 0)
			{
	...
	case _DMSLINE_:
		{
			...
			if(d5000.d5000_WriteData("LINE",query,temp_line,number,3,attrs,error_info) != 0)
			{
				SetGError(2,0,g_strfiletypeName[arg],_DMSEMSRT_-2,error_info,threadlog);
...
int resolvexmldata::deleteDBDate(int code,int arg)
{
	...
	//const char *g_xmltypeName[] = {"DMSOP","DATT","DAGC","YXBW","GPZW","DMSGPZW","GPMSGPZW","ZDZX","YKCZ","YXINFO","DMSCIME","GPMSCIME","DMSDATA","GPMSDATA","END"};
	const char *g_xmltypeName[] = {"DMSOP","DATT","DAGC","YXBW","GPZW","DMSBRAND","GPMSGPZW","ZDZX","YKCZ","YXINFO","YCRATE","DMSBUS","DMSCB","DMSCB","DMSLD","DMSST","DMSTD","AUTOGRAPH","TDINFO","FACTION","TZDETAILS","GPMSTD","GPMSTDDET","GPMS_ZLP","DMS_ZLP","DMS_XSD","DMS_ZTGJ","DMS_YD","GZZSQ","YCRT","END"};
